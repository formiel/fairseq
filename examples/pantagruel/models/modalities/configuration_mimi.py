...
class MimiConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        use_causal_conv=False, # default to False for Mimi encoder used in Pantagruel
        pad_mode="constant",
        compress=2,
        ...
        is_causal=False, # added for Mimi encoder transformer used in Pantagruel
        **kwargs,
    ):
        ...
        self.is_causal = is_causal # added for Mimi encoder used in Pantagruel
